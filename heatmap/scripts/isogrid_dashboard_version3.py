#!/usr/bin/env python3
"""
Version 3 dashboard: builds on v2 and adds
- Top-5 near-optimal alternatives list in Optimizer output (besides the best, red marker).
- Pattern preview uses dimensions from the optimized geometry (b, t, a, L) if available.
- Minor UI: v3 title; same controls as v2.
"""
  ...
  <div class=\"wrap\">
    <div class=\"panel\">
      ...
      <div class=\"ctrl\">
        ...
        <div class=\"row\">
          <input id=\"nAll\" type=\"range\" min=\"1\" max=\"100\" step=\"1\" value=\"%(n_all)d\" />
...
def main():
    ap = argparse.ArgumentParser(description="Version 3 Isogrid/Honeycomb Dashboard generator")
    default_out = Path(__file__).resolve().parents[1] / "out" / "isogrid_dashboard_v3.html"
    ...
    print(f"Wrote dashboard v3: {args.out}")
